...
function transform(text) {
  ...
  console.log("valueis " +filterValue);
...
const filters = {
    ...
    funky:function(element){
        //first check if funky letter is present for this element
        let funkyLetter = funkyLetters[element];
        if(funkyLetter){
            return funkyLetter;
        }
        //if not found, check for its lowerversion
        funkyLetter = funkyLetters[element.toLowerCase()];
        if(funkyLetter){
            return funkyLetter;
        }
        //elsereturn the regular element
        return element
    },
    unable:function(element){
